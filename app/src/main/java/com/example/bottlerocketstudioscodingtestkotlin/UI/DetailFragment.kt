...
class DetailFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val phone_digits_only = phone!!.replace("\\D".toRegex(), "")

        val store_name = rootView.findViewById<TextView>(R.id.detail_store_name)
        val store_address = rootView.findViewById<TextView>(R.id.detail_store_address)
        val store_phone = rootView.findViewById<TextView>(R.id.detail_store_phone)

        store_name.text = name
        ...
        val phone_frame = rootView.findViewById<CardView>(R.id.number_frame)
        phone_frame.setOnClickListener {
        ...
        val get_directions_frame = rootView.findViewById<CardView>(R.id.get_directions_frame)
        get_directions_frame.setOnClickListener {
